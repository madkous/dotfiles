...
## Type: Dict
# c.bindings.key_mappings = {'<Ctrl-J>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Ctrl-[>': '<Escape>', '<Ctrl-6>': '<Ctrl-^>', '<Shift-Return>': '<Return>', '<Shift-Enter>': '<Return>', '<Ctrl-M>': '<Return>', '<Enter>': '<Return>'}
...
## Type: QssColor
c.colors.completion.item.selected.bg = '#387025'

## Bottom border color of the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.border.bottom = '#184000'

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.item.selected.border.top = '#184000'
...
## Type: QssColor
c.colors.completion.match.fg = '#aa0000'

## Background color of the completion widget for odd rows.
## Type: QssColor
c.colors.completion.odd.bg = '#0f0d0c'
...
## Type: QtColor
c.colors.downloads.start.bg = '#882200'
...
## Type: QtColor
c.colors.downloads.stop.bg = '#005500'

## Color gradient end for download text.
## Type: QtColor
c.colors.downloads.stop.fg = 'lightgray'
...
## Type: QssColor
c.colors.keyhint.bg = 'qlineargradient(x1:0, y1:1, x2:0, y2:0, stop:0 black, stop:1 rgba(0, 0, 0, 0.9))'
...
## Type: QssColor
c.colors.keyhint.suffix.fg = '#dddd00'
...
## Type: QssColor
c.colors.statusbar.command.fg = 'lightgray'
...
## Type: QssColor
c.colors.statusbar.insert.fg = 'lightgray'
...
## Type: QssColor
c.colors.statusbar.normal.fg = 'lightgray'
...
## Type: QssColor
c.colors.statusbar.private.fg = 'lightgray'
...
## Type: QssColor
c.colors.statusbar.url.hover.fg = '#00dddd'
...
## (https).
## Type: QssColor
c.colors.statusbar.url.success.https.fg = '#00ee00'

## Foreground color of the URL in the statusbar when there's a warning.
## Type: QssColor
c.colors.statusbar.url.warn.fg = '#dddd00'
...
## Type: QtColor
c.colors.tabs.selected.even.bg = '#0f0d0c'
...
## Type: QtColor
c.colors.tabs.selected.odd.bg = '#0f0d0c'
...
## Type: Dict
# c.content.javascript.log = {'info': 'debug', 'error': 'debug', 'warning': 'debug', 'unknown': 'debug'}
...
## default is used.
## Type: Directory
c.downloads.location.directory = '/home/kous/files/downloads/'
...
# c.spellcheck.languages = ['en-GB', 'de-DE']
...
## Type: Padding
# c.statusbar.padding = {'bottom': 1, 'left': 0, 'top': 1, 'right': 0}
...
## Type: Padding
# c.tabs.indicator_padding = {'bottom': 2, 'left': 0, 'top': 2, 'right': 4}
...
## Type: Padding
# c.tabs.padding = {'bottom': 0, 'left': 5, 'top': 0, 'right': 5}
...
c.url.searchengines = {'DEFAULT': 'https://duckduckgo.com/?q={}',
        ...
        'ww': 'https://en.wiktionary.org/w/index.php?search={}',
        'wwd': 'https://de.wiktionary.org/w/index.php?search={}',
        'i': 'https://duckduckgo.com/?q={}&iax=images&ia=images',
        'd': 'https://duckduckgo.com/?q={}',
        'dd': 'https://duckduckgo.com/html/?q={}',
        'p': 'https://packages.gentoo.org/packages/search?q={}',
        'h': 'https://www.haskell.org/hoogle/?hoogle={}',
        'r': 'https://old.reddit.com/r/{}',
        'rp': 'https://www.redditp.com/r/{}',
        'n': 'https://ncatlab.org/nlab/search?query={}',
...
config.bind(',v', 'spawn watch_video {url}')
config.bind(',V', 'hint links spawn watch_video {hint-url}')
config.bind(',y', 'spawn youtube-dl {url}')
config.bind(',Y', 'hint links spawn youtube-dl {hint-url}')
config.bind(',i', 'hint images yank')
config.bind(',I', 'hint images yank-primary')
